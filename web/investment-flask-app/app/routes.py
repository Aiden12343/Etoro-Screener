...
import csv
from .metrics import fetch_user_data, load_instrument_map, map_instrument_ids, fetch_risk_score_data
...
# Route for searching user portfolio via form submission
...
def user_performance(username):
    try:
        ...
        user_heatmap_data, portfolio_data, _ = fetch_user_data(username)
